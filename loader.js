...
// @match *://*.doujins.com/*
// @match *://www.8muses.com/comics/picture/*/*/*/*
...
var nsfwimp = [{
	...
	next: '.photo > a',
	curpage: function() {
		return document.querySelector('title').innerText.match(/^Page (\d+)/)[1]
	},
	numpages: function() {
		return document.querySelector('[rel="last"]').href.match(/\/(\d+)$/)[1]
	}
}, {
	name: 'hitomi',
...
log('loading sfw implementations...');
